...
$about = "Teodor Rofleston. No need to introduce for restaurant business' segment. Cookin'World magazine's best reviewer of the years 2012-2014, 2019, 2021.<br/>";
$about .= "I've examined food and found some masterpieces in almost 300 restaurants around the globe. Listen to me, read me and you won't be fooled.<br/>";
$about .= "Give master-chief a good fish, and you'll save him 7 pounds, give him a sharp advice instead of a good fish and he will surely remember ya forever! <br/>";
$UsrDba->updateAdditionalInfo($Ted->getUserId(), nl2br($about), $EN_lang_id, $DBModCntxt);
//RU
...
$about = "Теодор Рофлстоун. Не нуждаюсь в представлении для ресторанного бизнеса. Лучший обозреватель издания Cookin'World magazine с 2012 по 2014 год, а также в 2019, 2021 годах.<br/>";
$about .= "Я пробовал еду и открывал редкие шедевры в 300 ресторанах мира. Слушай меня, читай меня и тебя не смогут обмануть.";
$about .= "Дай шефу хорошую рыбу, и ты сэкономишь ему немного денег. Дай ему меткий совет вместо хорошей рыбы, и он точно тебя запомнит навсегда! <br/>";
$UsrDba->updateAdditionalInfo($Ted->getUserId(), nl2br($about), $RU_lang_id, $DBModCntxt);
