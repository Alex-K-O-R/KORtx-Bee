...
$about = "You don't know why am I leaving. Or where I'm gonna go.<br/>";
$about .= "You see, I've got my reasons, but you just don't want to know.<br/>";
$about .= "Cause for 28 years you've never ever mentioned Alice... <br/>";
...
$about = "Не знаешь ты зачем и почему я ухожу.<br/>";
$about .= "На то ведь есть причины, но тебе их не скажу.<br/>";
$about .= "Ведь все 28 лет подряд не видел ты девчонку Элис...<br/>";
