...
$usrCrPath = $_SERVER['DOCUMENT_ROOT'].'/core/expansion'; // this is extensions path, user should do things and wonders right there
...
require_once($InstallationSourcePath.'/sources/Application.php');
...
switch($step){
    case 0:
        require_once($InstallationSourcePath.'/steps/1/index.php');
        break;
    ...
    case 1:
        if($project_url){
            ...
            copy($InstallationSourcePath.'/inc/This section is autogenerated.txt', $rootCrPath.'/This section is autogenerated.txt');
            if(!is_readable($rootCrPath.'/This section is autogenerated.txt')){
                echo(
    ...
    case 2:
        if($db_host && $db_type){
            if(is_dir($db_src)){
                ...
                require_once($InstallationSourcePath.'/steps/3/index.php');
            }
        } else {
            require_once($InstallationSourcePath.'/steps/2/index.php');
        }
    ...
    case 3:
        if($project_keyword){
            ...
            require_once($InstallationSourcePath.'/inc/include_dbconstants.php');
            ...
            require_once($InstallationSourcePath.'/steps/4/index.php');
        } else {
            require_once($InstallationSourcePath.'/steps/3/index.php');
        }
        break;
    ...
    case 4:
        if($adm_login && $adm_pass){
            ...
            require_once($InstallationSourcePath.'/inc/include_dbas.php');
            ...
            require_once($InstallationSourcePath.'/steps/5/index.php');
        } else {
            require_once($InstallationSourcePath.'/steps/4/index.php');
        }
        break;
    ...
    case 5:
        if(CIS::l($_POST, 'add_demo', false)){
            ...
            require_once($InstallationSourcePath.'/inc/demo/Alice.php');
            require_once($InstallationSourcePath.'/inc/demo/Lilly.php');
            require_once($InstallationSourcePath.'/inc/demo/Ted.php');
        ...
        $nodes_path = $_SERVER['DOCUMENT_ROOT'].'/nodes';
        FileDBA::createDirectoryWithRights($nodes_path);
        FileDBA::copyRecursive($InstallationSourcePath.'/demo/nodes', $nodes_path);
